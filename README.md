...
- Full edition: `NIKKE_Arena_Tool_Setup_0.1.19.exe`
- Lite edition: `NIKKE_Arena_Capture_Lite_Setup_0.1.11.exe`
...
当前发布版本：完整版 `0.1.19`，轻量版 `0.1.11`。安装包与升级补丁通过 GitHub Releases 发布，不直接提交到 Git 仓库。
